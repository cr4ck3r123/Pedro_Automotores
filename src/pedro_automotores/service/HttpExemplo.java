 ...
 */
package pedro_automotores.service;
...
public class HttpExemplo {
    ...
    private final String USER_AGENT = "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/110.0, Chrome";
...
//        Type usuarioType = new TypeToken<USD>() {
//        }.getType();
//             
//        String json = g.toJson(cota, usuarioType);
